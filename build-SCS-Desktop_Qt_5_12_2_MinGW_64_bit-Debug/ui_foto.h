...
public:
    ...
    void setupUi(QDialog *Foto)
    {
        ...
        Alumno->setGeometry(QRect(170, 50, 121, 41));
...
"hover!pressed:border: 5px solid blue;"));
        ...
        label_5->setGeometry(QRect(150, 20, 171, 41));
...
""));
    ...
    void retranslateUi(QDialog *Foto)
    {
        ...
        Alumno->setText(QApplication::translate("Foto", "Alumno", nullptr));
        ...
        label_5->setText(QApplication::translate("Foto", "Bienvenido ", nullptr));
