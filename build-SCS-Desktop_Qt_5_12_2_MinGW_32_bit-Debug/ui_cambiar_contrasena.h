...
public:
    ...
    void setupUi(QDialog *Cambiar_Contrasena)
    {
        ...
        Cambiar_Contrasena->setWindowIcon(icon);
...
"    margin-top: 0.5em;"));
    ...
    void retranslateUi(QDialog *Cambiar_Contrasena)
    {
        ...
        Alumno->setText(QApplication::translate("Cambiar_Contrasena", "Contrase\303\261a", nullptr));
        label_5->setText(QApplication::translate("Cambiar_Contrasena", "Cambiar", nullptr));
