...
public:
    ...
    void setupUi(QDialog *inicio)
    {
        ...
        lineEdit->setGeometry(QRect(0, -10, 371, 261));
...
"    border-radius: 6px;\n"
"    margin-top: 0.5em;"));
        Contrasena->setEchoMode(QLineEdit::Normal);
...
""));
    ...
    void retranslateUi(QDialog *inicio)
    {
        ...
        Contrasena->setPlaceholderText(QCoreApplication::translate("inicio", "Contrase\303\261a", nullptr));
        Matricula->setText(QString());
        Matricula->setPlaceholderText(QCoreApplication::translate("inicio", "Matricula", nullptr));
        Inicio_sesion->setText(QCoreApplication::translate("inicio", "Iniciar sesi\303\263n", nullptr));
        Olvidaste_Contrasena->setText(QCoreApplication::translate("inicio", "\302\277Olvidaste tu contrase\303\261a?", nullptr));
        label_4->setText(QString());
        label->setText(QCoreApplication::translate("inicio", "School System", nullptr));
